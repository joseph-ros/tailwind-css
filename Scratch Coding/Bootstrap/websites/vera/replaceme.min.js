!function (a, b) {
    ...
    function d() {
        "function" == typeof b && b.fn.extend({
            ReplaceMe: function (a) {
                return this.each(function () { new e(this, a) })
            }
        })
    }
    ...
    function e(a, b) {
        ...
        if (
            "object" == typeof b ? this.options = c(d, b) : this.options = d, "undefined" == typeof a
        )
            throw new Error(
        ...
        if ("object" == typeof a) this.element = a;
            ...
            if ("string" != typeof a) throw new Error('ReplaceMe [constructor]: wrong "element" parameter'); this.element = document.querySelector(a)
        } this.init()
    }
    ...
    e.prototype.init = function () {
        ...
        , e.prototype.pause = function () { clearTimeout(this.loop) }
        ...
        , e.prototype.escapeHTML = function (a) {
            var b = /<\/?\w+\s*[^>]*>/g; return b.test(a) === !0 ? a.replace(b, "") : a
        }, a.ReplaceMe = e, d()
